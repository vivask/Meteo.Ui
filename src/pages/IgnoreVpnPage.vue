    ...
    <div class="row justify-center items-start crisper">
      ...
      >
        <q-item class="bot-line">
            <q-item-label class="text-bold text-h6">Hosts excluded from VPN</q-item-label>
        </q-item>
        <q-table
        hide-header
        :rows="rows"
        ...
        >
          <template v-slot:body-cell-actions="props">
            <q-td :props="props">
              <q-btn class="q-ml-xs" dense round color="primary" size="md" icon="mdi-ballot-recount" @click="onRecovery(props.row)"></q-btn>
