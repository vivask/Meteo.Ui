      ...
      <div class="square rounded-borders" :class="cols">
        <q-item class="bot-line">
          <q-item-label class="text-bold text-h6"
            >Hosts excluded from VPN</q-item-label
          >
        </q-item>
        <q-table
          hide-header
...
export default {
  setup() {
    ...
    return {
      ...
      async GetRecords() {
        await axios
          .get("/api/v1/admin/proxy/ignorevpn/get")
          .then((response) => {
      ...
      onRestore(row) {
        ...
        $q.dialog({
          ...
          await axios
            .put("/api/v1/admin/proxy/ignorevpn/restore", data)
            .then(() => {
              this.GetRecords();
            })
            .catch((err) => {
      ...
      onDelete(row) {
        ...
        $q.dialog({
          ...
          await axios
            .put("/api/v1/admin/proxy/ignorevpn/delete", data)
            .then(() => {
              this.GetRecords();
            })
            .catch((err) => {
