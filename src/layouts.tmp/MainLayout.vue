<template>
  <q-layout view="lHh Lpr lFf">
    ...
    <q-drawer v-model="leftDrawerOpen" show-if-above bordered :width="250" class="bg-grey-3">
      <q-list>
      ...
      <q-expansion-item expand-separator v-model="peripheral">
        ...
        <q-expansion-item label="BME280" v-model="bme280" switch-toggle-side dense-toggle>
          <q-item
            active-class="menu-item"
            class="sub-menu-item"
            clickable
        ...
        <q-expansion-item label="MICS6814" v-model="mics6814" switch-toggle-side dense-toggle>
          <q-list>
            <q-item
              active-class="menu-item"
              class="sub-menu-item"
        ...
        <q-expansion-item label="RadSens" v-model="radsens" switch-toggle-side dense-toggle>
          <q-list>
            <q-item
              active-class="menu-item"
              class="sub-menu-item"
        ...
        <q-expansion-item label="ZE08CH2O" v-model="ze08ch2o" switch-toggle-side dense-toggle>
          <q-list>
            <q-item
              active-class="menu-item"
              class="sub-menu-item"
        ...
        <q-expansion-item label="DS18B20" v-model="ds18b20" switch-toggle-side dense-toggle>
          <q-list>
            <q-item
              active-class="menu-item"
              class="sub-menu-item"
      ...
      <q-expansion-item v-model="services" expand-separator v-if="isAuthenticated">
        <template v-slot:header>
          <q-item-section avatar>
        ...
        <q-expansion-item label="Proxy" v-model="proxy" switch-toggle-side dense-toggle>
          <q-list>
            <q-item
              active-class="menu-item"
              class="sub-menu-item"
        ...
        <q-expansion-item label="Schedule" v-model="schedule" switch-toggle-side dense-toggle>
          <q-list>
            <q-item
              active-class="menu-item"
              class="sub-menu-item"
        ...
        <q-expansion-item label="Secure" v-model="secure" switch-toggle-side dense-toggle>
          <q-list>
            <q-item
              active-class="menu-item"
              class="sub-menu-item"
        ...
        <q-expansion-item label="Database" v-model="database" switch-toggle-side dense-toggle>
          <q-list>
            <q-item
              active-class="menu-item"
              class="sub-menu-item"
        ...
        <q-expansion-item label="Servers" v-model="servers" switch-toggle-side dense-toggle>
          <q-list>
            <q-item
              active-class="menu-item"
              class="sub-menu-item"
        ...
        <q-expansion-item label="Radius" v-model="radius" switch-toggle-side dense-toggle>
          <q-list>
            <q-item
              active-class="menu-item"
              class="sub-menu-item"
